...
public class ProdutoDAO {
	...
	public void insere(Produto produto) {
		...
		try {
			...
			ps.executeUpdate(); //é executeUpdate pois quando nos modificamos o estado do bando sempre vai ser update
								// se for inserir, editar, excluir é update .. só consulta se que query
			conn.close();
